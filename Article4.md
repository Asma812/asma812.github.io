...
**Impact**: Poisoning is particularly dangerous because it is difficult to detect. The model’s performance metrics (accuracy, precision) may remain high during testing, but its fundamental understanding of what constitutes a "threat" has been compromised at the root.
